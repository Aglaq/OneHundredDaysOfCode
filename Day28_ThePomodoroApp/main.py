...
# Day 28 - Project: The Pomodoro App
from tkinter import *
import math
# ---------------------------- CONSTANTS ------------------------------- #
PINK = "#e2979c"
...
def count_down(count):
    ...
    if count > 0:
        ...
        checkmarks_label.config(text="✔"*checkmarks_number)
...
title_label = Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 48, "normal"))
title_label.grid(column=1, row=0)

checkmarks_label = Label(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 24, "normal"))
